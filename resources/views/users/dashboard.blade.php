                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                @php
                                $maintenanceStatuses = \App\Models\Admin\Maintenance::where('request_status', 'Approved / Ongoing')
                                    ->where('u_id', auth()->user()->id)
                                    ->get();
                                $maintenances = \App\Models\Admin\Maintenance::where('request_status', 'Approved / Ongoing')
                                    ->where('u_id', auth()->user()->id)
                                    ->get();
                                @endphp
