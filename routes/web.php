...
Route::namespace('App\Http\Controllers\Admin')
    ...
    ->group(function () {
        ...
        Route::get('admin/building/print', [CTRLbuilding::class, 'printAll'])->name('building.print');
        ...
        Route::get('/admin/building/archived', [CTRLbuilding::class, 'archived'])->name('building.archived');
        ...
        Route::get('/maintenance/{id}/completion-form', [CTRLmntnns::class, 'showCompletionForm'])->name('maintenance.showcompletion');
...
Route::namespace('App\Http\Controllers\Users')
    ...
    ->group(function () {
        ...
        Route::get('/maintenance/{id}/completion-form', [CTRLMaintenance::class, 'completionForm'])->name('maintenance.completionForm');
        Route::post('/completion-form', [CTRLMaintenance::class, 'storeCompletionForm'])->name('maintenance.completionForm.store');
